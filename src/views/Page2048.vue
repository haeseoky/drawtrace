<template>
  <div class="game-page">
    ...
    <Game2048 @score="onScore" @share="onShare" ref="gameRef" />
    <Leaderboard ref="lbRef" game-id="2048" />
    <ShareModal :visible="showShare" game-name="2048" :score="shareScore" @close="showShare = false" />
  </div>
</template>
<script setup>
import { ref } from 'vue'
